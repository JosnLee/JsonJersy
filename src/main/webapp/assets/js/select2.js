    ...
    AbstractSelect2 = clazz(Object, {
        ...
        positionDropdown: function() {
            ...
            if (above) {
                ...
                //TODO select2位置调整
                if(this.opts.minimumResultsForSearch >= 0 && !this.opts.dropdownAutoWidth){
                    dropTop = dropTop + 23;
                }
                this.container.addClass("select2-drop-above");
                $dropdown.addClass("select2-drop-above");
                //TODO select2input框位置调整
                $dropdown.find(".select2-results").detach().prependTo($dropdown);
            }
            else {
                //TODO select2位置调整
                if(this.opts.minimumResultsForSearch >= 0 && !this.opts.dropdownAutoWidth){
                ...
                //TODO select2input框位置调整
                $dropdown.find(".select2-results").detach().appendTo($dropdown);
        ...
        opening: function() {
            ...
            this.container.parents().add(window).each(function () {
                $(this).on(resize+" "+scroll+" "+orient, function (e) {
                    ...
                    //TODO select2滚动时候的高亮显示
                    that.ensureHighlightVisible();
                });
            });
